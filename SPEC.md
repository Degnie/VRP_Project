# ESPECIFICACIÓN VRP SOLVER (v1.9)
...
* **RN-029 (Orquestación - Reparto de Flota por Sector):** Todo sector con demanda > 0 recibe garantizado 1 vehículo antes de repartir el resto — priorizando a los sectores de mayor demanda si la flota total no alcanza para cubrir el piso de todos (los de menor demanda se quedan sin flota). El resto de la flota (preservando la proporción de cada tipo de vehículo) se distribuye entre los sectores en proporción al porcentaje de demanda total (suma de pesos) que cae en cada uno, sin exceder nunca la flota total disponible. Si, aun con su vehículo asignado, la demanda de un sector excede la capacidad de su sub-flota, los clientes que no caben (los más lejanos al depósito primero) se postergan igual que RN-026, en vez de rechazar la resolución completa del sector.
